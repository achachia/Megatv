    ...
    if ($nb > 0) {
        ...
        try {
            if ($categorie_client == '2BSZJL') {
                $sql = " SELECT ChainesTv.Nom_m3u,LinkTv.link AS source,CategorieTv.nom AS nom_categorie   FROM  LinkTv,ChainesTv,CategorieTv  WHERE  LinkTv.id_link=ChainesTv.id  AND ChainesTv.categorie=CategorieTv.id_categorie  AND ChainesTv.active='1' ";
                $sql.= " AND (categorie = '2'
                            OR categorie = '5'
                            OR categorie = '11'
                            OR categorie = '13'
                ...
                $sql = " SELECT ChainesTv.Nom_m3u,LinkTv.link AS source,CategorieTv.nom AS nom_categorie  ";
            ...
            while ($enregistrement = $resultat->fetch()) {
                print "#EXTINF:-1, group-title='" . $enregistrement['nom_categorie'] . "'," . $enregistrement['Nom_m3u'] . "\r\n";
