...
try {
    ...
    $sql = "   SELECT  ClientsMateriel.categorie_user,MaterielClients.code_client AS code_client,AbonnementsTv.date_debut,AbonnementsTv.code_active AS code_activation,AbonnementsTv.categorie_abo AS categorie_abo  FROM  MaterielClients,AbonnementsTv,ClientsMateriel ";
    ...
    if ($nb > 0) {
        ...
        try {
            ...
            while ($enregistrement = $resultat->fetch()) {
                ...
                print "#EXTINF:-1, group-title='" . $enregistrement['nom_categorie'] . "'," . $enregistrement['nom'] . "\r\n";
