...
if (isset($_POST['code_distinataire']) && !empty($_POST["code_distinataire"])) {
    ...
    try {
        ...
        $sql = " SELECT id_liaison FROM eleve_intervenant,membre_famille WHERE eleve_intervenant.code_famille=membre_famille.code_famille AND  code_intervenant='" . $_SESSION['membre']['code_intervenant'] . "'  ";
        $select = $cxn->query($sql);
