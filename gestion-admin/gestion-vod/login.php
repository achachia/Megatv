...
<link href="<?= Host; ?>/media/css/boostrap.min.css" rel="stylesheet" type="text/css"/>
<link href="<?= Host; ?>/media/css/css_login.css" rel="stylesheet" type="text/css"/>
<link href="<?= Host; ?>/media/fontawesome/css/font-awesome.css" rel="stylesheet" type="text/css"/>
...
<script src="<?= Host; ?>/media/js/jquery.js?c=943916400"></script>
<script src="<?= Host; ?>/media/js/bootstrap.min.js?c=943916400"></script>

</head>
<body  style="background: url(<?= Host; ?>/media/images/nos_chaines_tv.png)">
			  ...
			  <div class="col-sm-8 col-md-6 col-md-offset-4" style="margin-left: 24%;">
               ...
               <?php } ?>
				...
				<div class="account-wall">
					  <img class="profile-img" src=".<?= Host; ?>/media/images/user.png" alt="">
