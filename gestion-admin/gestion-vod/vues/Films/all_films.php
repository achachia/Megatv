<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">LISTES DES FILMS</div>
                        ...
                        if (isset($liste_fichiers)) {
                            ...
                            foreach ($liste_fichiers as $value) {
                                ...
                                $tr .= '<ul class="dropdown-menu">';                                      
                                        $tr .= '<li><a href="index.php?module=Films&action=add_film&mode=modifier&id_film=' . $value ['id_fichier'] . '" target="_blank"><button type="button" class="btn-primary" ><span class="glyphicon glyphicon-pencil"></span>Modifier la fiche</button></a></li>';
                                        ...
                                        $tr .= '<li><button type="button" class="btn-primary" name="delete_film"   id="' . $value ['id_fichier'] . '"><span class="glyphicon glyphicon-eye-open"></span>Supprimer</button></li>';
                                $tr .= '</ul>';
                                $tr .= '</div>';
                                $tr .= '</td>';
                                $tr .= '</tr>';
