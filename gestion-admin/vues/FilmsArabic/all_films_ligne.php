...
<div id="myModal_add_film_ligne" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" id="form_add_film_serveur" name="form_add_film_serveur" enctype="multipart/form-data" method="POST" action="./controleurs/FilmsArabic/set_film_en_ligne.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"  style="padding-top:1%">
                        <div class="col-sm-12">
                            <label class="control-label" for="id_ele_cineme_<?= $j; ?>" style="color:blue;font-size:16px">Identifiant El-cinema: <span style="color:red">(<i class="fa fa-asterisk" aria-hidden="true"></i>)</span></label>
                        </div>

                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="id_el_cinema"  name="id_el_cinema"  placeholder="Entrer identifiant el cinema"   value="" >
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= $url_espace_admin; ?>/controleurs/FilmsArabic/delete_links_serveur.php?id_link=<?= $serveur['id_link']; ?>"><button    class="btn btn-danger btn-md"  > Supprimer </button></a>
...
foreach ($liste_films_en_ligne as $film) {
    ...
    <div id="myModal_add_link_serveur_<?= $j; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" id="form_add_link_<?= $j; ?>" name="form_add_link_<?= $j; ?>" method="POST" action="./controleurs/FilmsArabic/add_link_servers.php">
                    <div class="modal-header">
