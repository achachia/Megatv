...
<div id="myModal_add_film_ligne" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" id="form_add_film_serveur" name="form_add_film_serveur" method="POST" action="./controleurs/DocumentaireFr/set_film_en_ligne.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label class="control-label" for="genre_doc_<?= $j; ?>" style="color:blue;font-size:16px">GENRE DOC: <span style="color:red">(<i class="fa fa-asterisk" aria-hidden="true"></i>)</span></label>
                        </div>


                        <div class="col-sm-12">

                            <select class="form-control" name="genre_doc"  id="genre_doc" >

                                <?php
                                $tr = '<option value="">Select-genre</option>';

                                foreach ($liste_genre_doc as $genre) {


                                    $tr.="<option value='" . $genre['nom_genre'] . "' ";

                                    $tr.= ">" . $genre['nom_genre'] . "</option>";
                                }
...
foreach ($liste_films_en_ligne as $film) {
    ...
    <div id="myModal_add_link_serveur_<?= $j; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" id="form_add_link_<?= $j; ?>" name="form_add_link_<?= $j; ?>" method="POST" action="./controleurs/DocumentaireFr/add_link_servers.php">
                    <div class="modal-header">
