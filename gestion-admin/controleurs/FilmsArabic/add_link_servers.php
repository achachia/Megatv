...
if ($etat) {
    ...
    $url = $url_espace_admin . "/index.php?module=FilmsArabic&action=".$action."&message=success";
} else {

    $url = $url_espace_admin . "/index.php?module=FilmsArabic&action=".$action."&message=echec";
}
