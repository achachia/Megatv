...
if ($_POST['action_module'] == 'all_documentaire') {
...
if ($etat) {
    ...
    $url = $url_espace_admin . "/index.php?module=DocumentaireFr&action=" . $action . "&message=success";
} else {

    $url = $url_espace_admin . "/index.php?module=DocumentaireFr&action=" . $action . "&message=echec";
}
