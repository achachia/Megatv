...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    ...
    $dir = "C:/wamp64/www/MegaTV-Backend/Media-Vod/Films-Hindo/";

    $source_fichier = "C:/wamp64/www/MegaTV-Backend/Media-Vod/Films-Hindo/";

    $fichierChemin = 'C:/wamp64/www/MegaTV-Backend/Kodi_strm/FilmsHindo/';

    $dir_jaquette = 'C:/wamp64/www/MegaTV-Backend/gestion-admin/images/JaquetteFilmsHindo/';
} else {


    $dir = "/volume1/web/media/Films-Hindo/";

    $source_fichier = '/web/media/Films-Hindo/';

    $fichierChemin = '/volume1/web/Kodi_strm/Films-Hindo/';

    $dir_jaquette = '/volume1/web/Megatv/MegatvProcedural/gestion-admin/images/JaquetteFilmsHindo/';
}
...
if (!empty($_POST['add_serveur'])) {
    ...
    if (isset($_FILES['affiche_movie']['name']) && !empty($_FILES['affiche_movie']['name'])) {
        ...
        $affiche_movie = 'http://megatv.ovh/gestion-admin/images/JaquetteFilmsHindo/poster_' . $MaxId . '.' . $imgExt;
    }
...
if ($etat) {
    ...
    $url = $url_espace_admin . "/index.php?module=FilmsHindo&action=all_films_ligne&message=success";
} else {

    $url = $url_espace_admin . "/index.php?module=FilmsHindo&action=all_films_ligne&message=echec";
}
