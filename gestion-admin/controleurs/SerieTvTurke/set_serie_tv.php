...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    ...
    $dir_jaquette = 'C:/wamp64/www/MegaTV-Backend/gestion-admin/images/JaquetteSerieEtrangere/JaquetteSerieTurke/JaquetteSerieTurke/';
} else {



    $dir_jaquette = '/volume1/web/Megatv/MegatvProcedural/gestion-admin/images/JaquetteSerieEtrangere/JaquetteSerieTurke/JaquetteSerieTurke/';
}
...
if (!empty($_POST['button_register'])) {
    ...
    try {
        ...
        $sql = " INSERT INTO  SerieTvEtrangere  (nom_serie,saisonsTv,type_serie,annee_release,overview,source) VALUES ('" . $nom_serie . "','" . $SaisonTv . "',2,'" . $annee_release . "','" . $overview . "','" . $source_serie . "')";
...
if ($etat) {
    ...
    $url = $url_espace_admin . '/index.php?module=SerieTvTurke&action=all_serie_tv_turke&saisonTV=' . $optionSaison . '&message=success';
} else {

    $url = $url_espace_admin . '/index.php?module=SerieTvTurke&action=all_serie_tv_turke&saisonTV=' . $optionSaison . '&message=echec';
}
