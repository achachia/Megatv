                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel widget">
                        <div class="row row-table row-flush">
                            ...
                            <div class="col-xs-6">
                                <div class="panel-body text-center">
                                    <h4 class="mt0">FILMS ARABIC</h4>
                                    <p class="mb0 text-muted"><?= $nb_films_arabic; ?> films</p>

                                </div>
                            </div>
                            <div class="col-xs-2 bg-info text-center"  style="min-height: 120px;padding-top: 20px">
                                <h4 class="mt0">DATA</h4>
                                <p class="mb0 text-muted"><?= $data_films_arabic; ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- END widget-->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel widget">
                        <div class="row row-table row-flush">
                            ...
                            <div class="col-xs-6">
                                <div class="panel-body text-center">
                                    <h4 class="mt0">FILMS HINDO</h4>
                                    <p class="mb0 text-muted"><?= $nb_films_hindo; ?> films</p>

                                </div>
                            </div>
                            <div class="col-xs-2 bg-info text-center"  style="min-height: 120px;padding-top: 20px">
                                <h4 class="mt0">DATA</h4>
                                <p class="mb0 text-muted"><?= $data_films_hindo; ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- END widget-->
