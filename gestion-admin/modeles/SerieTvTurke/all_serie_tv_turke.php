...
function liste_serie() {
    ...
    if ($_SERVER['SERVER_NAME'] == 'localhost') {
        ...
        $dir = "C:\wamp64\www\MegaTV-Backend\Media-Vod\Serie-Tv-turke";
    } else {

        $dir = "/volume1/web/media/Serie-Tv-turke";
    }
        ...
        if (!in_array($value, array(".", ".."))) {
            ...
            if (is_dir($dir . DIRECTORY_SEPARATOR . $value)) {
                ...
                try {
                    ...
                    $sql = " SELECT  id_serie,nom_serie,poster,activation,SaisonsTv   FROM  SerieTvEtrangere   WHERE  nom_serie='" . $value . "'  AND   type_serie=2    ORDER BY id_serie DESC ";
...
function liste_saisons($id_serie, $nom_serie) {
    ...
    if ($_SERVER['SERVER_NAME'] == 'localhost') {
        ...
        $dir = "C:/wamp64/www/MegaTV-Backend/Media-Vod/Serie-Tv-turke/" . $nom_serie;
    } else {

        $dir = "/volume1/web/media/Serie-Tv-turke/" . $nom_serie;
    }
...
function liste_episodes($id_serie, $nom_serie, $nom_saison = NULL) {
    ...
    if ($_SERVER['SERVER_NAME'] == 'localhost') {
        ...
        if (is_null($nom_saison)) {
            ...
            $dir = "C:/wamp64/www/MegaTV-Backend/Media-Vod/Serie-Tv-turke/" . $nom_serie . "/" . $nom_saison;
        }
    } else {
        ...
        if (is_null($nom_saison)) {
            ...
            $dir = "/volume1/web/media/Serie-Tv-turke/" . $nom_serie . "/" . $nom_saison;
        }
    }
