            ...
            <nav role="navigation" class="navbar navbar-default navbar-top navbar-fixed-top">
                ...
                <div class="navbar-header">
                    <a href="#" class="navbar-brand">
                        <div class="brand-logo">MEGA-TV [BOUQUET]</div>
                                    ...
                                    <div class="scroll-viewport">
                                        ...
                                        <div class="list-group scroll-content">
                                            ...
                                            <a href="#" class="list-group-item">
                                                <div class="media">
                                                    <div class="pull-left">
                                                        <img style="width: 48px; height: 48px;" src="http://megatv.fr/gestion-admin/app/img/user/01.jpg" alt="Image" class="media-object img-rounded">
                                                    </div>
                                            ...
                                            <a href="#" class="list-group-item">
                                                <div class="media">
                                                    <div class="pull-left">
                                                        <img style="width: 48px; height: 48px;" src="http://megatv.fr/gestion-admin/app/img/user/04.jpg" alt="Image" class="media-object img-rounded">
                                                    </div>
                                                    <div class="media-body clearfix">
                                            ...
                                            <a href="#" class="list-group-item">
                                                <div class="media">
                                                    <div class="pull-left">
                                                        <img style="width: 48px; height: 48px;" src="http://megatv.fr/gestion-admin/app/img/user/03.jpg" alt="Image" class="media-object img-rounded">
                                                    </div>
                                                    <div class="media-body clearfix">
                                            ...
                                            <a href="#" class="list-group-item">
                                                <div class="media">
                                                    <div class="pull-left">
                                                        <img style="width: 48px; height: 48px;" src="http://megatv.fr/gestion-admin/app/img/user/05.jpg" alt="Image" class="media-object img-rounded">
                                                    </div>
                                                    <div class="media-body clearfix">
                                                        <small class="pull-right">4h</small>
                                                        <strong class="media-heading text-primary">
                                            ...
                                            <a href="#" class="list-group-item">
                                                <div class="media">
                                                    <div class="pull-left">
                                                        <img style="width: 48px; height: 48px;" src="http://megatv.fr/gestion-admin/app/img/user/06.jpg" alt="Image" class="media-object img-rounded">
                                                    </div>
                                                    <div class="media-body clearfix">
                                                        <small class="pull-right">4h</small>
                                                        <strong class="media-heading text-primary">
